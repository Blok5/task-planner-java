package ru.oleg.taskplanner.engine;

import ru.oleg.taskplanner.model.DailyRepeatable;
import ru.oleg.taskplanner.model.MonthlyRepeater;
...
import ru.oleg.taskplanner.model.YearlyRepeater;
        ...
        try (Scanner scanner = new Scanner(System.in)) {
            while (true) {
                ...
                if (scanner.hasNextInt()) {
                    ...
                    scanner.nextLine(); //для считывания символа новой строки, который остался во входном потоке.
                    switch (menu) {
